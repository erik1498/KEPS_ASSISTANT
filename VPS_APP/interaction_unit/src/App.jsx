  ...
  return (
    <Router>
      <Suspense fallback={<LoadingPage />}>
        ...
        <Routes basename={pengirimanBarangPath.main}>
          <Route path={pengirimanBarangPath.main} element={<PengirimanBarangPage />} />
        </Routes>
        ...
        <Routes basename={penggunaanPerlengkapanPath.main}>
          <Route path={penggunaanPerlengkapanPath.main} element={<PenggunaanPerlengkapanPage />} />
        </Routes>
