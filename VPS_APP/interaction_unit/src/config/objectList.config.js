...
export const ASETTETAPDANPERLENGKAPANSUMBERLIST = [
    "PEMBELIAN ASET",
    "HITUNGAN PENYUSUTAN ASET",
...
export const PERINTAHSTOKOPNAMESUMBERLIST = [
    ...
    "PELUNASAN DENDA PEMBELIAN BARANG",
    "RETUR PENJUALAN BARANG",
    "RETUR PEMBEILAN BARANG",
    "PENGEMBALIAN DENDA PENJUALAN BARANG",
    "PENGEMBALIAN DENDA PEMBELIAN BARANG",
    "DENDA PENJUALAN BARANG",
    "DENDA PEMBELIAN BARANG",
    "STOK AWAL BARANG",
]
