    ...
    return <div className={`flex flex-col w-full bg-white text-[13px] ${forPrint ? '' : 'px-3 shadow-md'}`}>
...

        {
            item.buktiTransaksi.map(item1 => {
                return <>
                    {
                        item1.sumber == "JURNAL UMUM" ||
                            item1.sumber == "NERACA BULAN SEBELUMNYA"
                            ? <>
                                ...
                                {
                                    item1.sumber == "GAJI PEGAWAI" ||
                                        item1.sumber == "TUNJANGAN UANG PEGAWAI" ||
                                        item1.sumber == "LEMBUR PEGAWAI" ||
                                        item1.sumber == "HADIAH PEGAWAI"
                                        ?
                                        <>
                                            <PendapatanRowData
                                                item1={item1}
