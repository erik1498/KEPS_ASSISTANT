...
import { AKUN_TIDAK_BOLEH_DIUPDATE, TipeTransaksiKasBankKodeAkunForm, TipeTransaksiPayrollKodeAkunForm, TipeTransaksiPembelianAsetDanPerlengkapanKodeAkunForm } from "../../../config/objectList.config"
                            ...
                            <table className="table">
                                ...
                                <thead>
                                    <tr className="sticky top-0 bg-white py-4 text-black">
                                        ...
                                        <th>Tipe Untuk Transaksi Pembelian Aset Dan Perlengkapan</th>
                                        <th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        kodeAkun?.map((item, i) => {
                                            return <>
                                                <tr key={i}>
                                                    ...
                                                    <td>{TipeTransaksiPembelianAsetDanPerlengkapanKodeAkunForm.filter(x => x.value == item.type_transaksi_pembelian_aset_dan_perlengkapan).at(0).label}</td>
