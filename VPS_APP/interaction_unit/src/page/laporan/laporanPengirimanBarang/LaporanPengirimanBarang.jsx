...
const LaporanPengirimanBarangPage = () => {
    ...
    const _getLaporanPengiriman = () => {
        setRiwayatLaporan(x => x = [])
        apiFakturPenjualanBarangCRUD
            .custom(`/rincian_pengiriman_barang_by_faktur/${fakturPenjualanBarang?.value}`, "POST", null, {
                data: {
    ...
    >
        <div>
            <PageTitle title="Laporan Pengiriman Barang" />
                ...
                <div className="col-span-12 h-[80vh] overflow-y-scroll no-scrollbar">
                    <div className="bg-white rounded-b-md px-7 py-3">
                        <div className="flex justify-between pb-5">
                            ...
                            >
                                <FaPager /> Lihat Riwayat Pengiriman
                            </button>
                        </div>
                                    ...
                                    </div>
                                    {
                                        riwayatLaporan?.filter(x => x.rincian_pesanan_penjualan_barang == item.uuid).length > 0 ? <>
                                            <div className="grid grid-cols-12 bg-gray-50 gap-x-2 border-y-2 py-1 border-gray-200 items-center">
                                                ...
                                                <div className="col-span-3">
                                                    <p className="text-xs font-bold">Tanggal Pengiriman</p>
                                                </div>
...
export default LaporanPengirimanBarangPage