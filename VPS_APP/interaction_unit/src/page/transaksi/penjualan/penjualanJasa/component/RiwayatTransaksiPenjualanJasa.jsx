...
import RiwayatTransaksiPelunasanPenjualanJasa from "./RiwayatTransaksiPelunasanPenjualanJasa"
import { apiFakturPenjualanJasaCRUD, apiKodeAkunCRUD, apiPelunasanPenjualanJasaCRUD, apiPengembalianDendaPenjualanJasaCRUD, apiReturPenjualanJasaCRUD } from "../../../../../service/endPointList.api"
...
const RiwayatTransaksiPenjualanJasa = ({
    fakturPenjualanJasa,
    setFakturCancel = () => { },
    ...
    const tipeTransaksiPenjualanJasa = ["Pelunasan", "Retur", "Pengembalian_Denda"]
    ...
    return <>
        <div className="bg-white rounded-md mt-4 py-6 px-6 shadow-2xl">
            <h1 className="text-xl font-extrabold w-max text-white px-2 rounded-md bg-blue-900 mb-4">Riwayat Transaksi Penjualan Jasa</h1>
...
export default RiwayatTransaksiPenjualanJasa