...
export const PesananPenjualanBarangPrint = React.forwardRef((props, ref) => {
    return (
        <div
            ref={ref}
        >
            <PDFHeader
                bulan={props.bulan}
                tahun={props.tahun}
                title={"PESANAN PENJUALAN BARANG"}
            />
            <div className="flex justify-between">
                ...
                <div className="text-right">
                    ...
                    <p>{formatDate(props.tanggalPesananPenjualanBarang)}</p>
                </div>
            </div>
            <div className="flex justify-between">
                <div className="mt-6">
                    <p className="font-bold">NO PESANAN PENJUALAN BARANG :</p>
                    <p>{props.nomorPesananPenjualanBarang}</p>
                </div>
            </div>
