...
import JurnalStokOpnameRowData from "./JurnalStokOpnameRowData";

const JurnalStokOpnameRow = ({
    item,
    balanceStatus = true,
    forPrint = false
}) => {
    return <div className={`flex flex-col w-full bg-white text-[13px] ${forPrint ? '' : 'shadow-md'}`}>
