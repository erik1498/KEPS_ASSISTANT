                            ...
                            j <= item2.length ? <>
                                ...
                                <div className="grid grid-cols-12 items-start py-1">
                                    ...
                                    <div className="text-right px-2 col-span-2 text-gray-900">
                                        {
                                            parseFloat(item3.debet).toFixed(2) ? <h1 className=" text-green-900 font-bold">{parseToRupiahText(item3.debet.toFixed(2))}</h1> : <></>
                                        }
                                    </div>
                                    <div className="text-right px-2 col-span-2 text-gray-900">
                                        {
                                            parseFloat(item3.kredit).toFixed(2) ? <h1 className=" text-red-900 font-bold">{parseToRupiahText(item3.kredit.toFixed(2))}</h1> : <></>
                                        }
                                    </div>
                                </div>
                            </> : <></>
