...
export const pengembalianDendaPenjualanJasaValidation = (payload) => {
    const schema = Joi.object({
        faktur_penjualan_jasa: Joi.string().required().messages({
        ...
        nomor_pengembalian_denda_penjualan_jasa: Joi.string().required().messages({
            'string.base': "Harus Berupa Text",
            "string.empty": "Harus Diisi",
            "any.required": "Harus Diisi",
        }),
