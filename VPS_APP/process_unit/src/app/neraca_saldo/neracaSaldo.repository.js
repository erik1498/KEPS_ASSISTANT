    ...
    const neracaSaldo = await db.query(
        `   
            ...
            FROM (
                ...
                UNION ALL
                SELECT 
                    tut.kode_akun_perkiraan_bpjs_karyawan AS kode_akun_perkiraan,
                    LPAD(MONTH(tut.tanggal), 2, '0') AS bulan,
                    YEAR(tut.tanggal) AS tahun,
                    0 AS debet,
                ...
                UNION ALL
                SELECT 
                    tut.kode_akun_perkiraan_jp_karyawan AS kode_akun_perkiraan,
                    LPAD(MONTH(tut.tanggal), 2, '0') AS bulan,
                    YEAR(tut.tanggal) AS tahun,
                    0 AS debet,
                ...
                UNION ALL
                SELECT 
                    tut.kode_akun_perkiraan_jht_karyawan AS kode_akun_perkiraan,
                    LPAD(MONTH(tut.tanggal), 2, '0') AS bulan,
                    YEAR(tut.tanggal) AS tahun,
                    0 AS debet,
