...
router.get("/kas", authTokenMiddleware(), getAllKodeAkunPerkiraans)
router.get("/no_kas", authTokenMiddleware(), getAllKodeAkunPerkiraans)
router.get("/bank", authTokenMiddleware(), getAllKodeAkunPerkiraans)
router.get("/no_bank", authTokenMiddleware(), getAllKodeAkunPerkiraans)
