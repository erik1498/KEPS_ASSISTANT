...
import { deleteRincianPesananPenjualanBarangByUUID, getAllRincianPesananPenjualanBarangs, getRincianPesananPenjualanBarangByPesananPenjualanUUID, postCreateRincianPesananPenjualanBarang, updateRincianPesananPenjualanBarangByUUID } from "./rincianPesananPenjualanBarang.handler.js"
import { authTokenMiddleware } from "../../middleware/auth.js"

const router = express.Router()

router.get("/", authTokenMiddleware(), getAllRincianPesananPenjualanBarangs)
router.get("/:uuid", authTokenMiddleware(), getRincianPesananPenjualanBarangByPesananPenjualanUUID)
