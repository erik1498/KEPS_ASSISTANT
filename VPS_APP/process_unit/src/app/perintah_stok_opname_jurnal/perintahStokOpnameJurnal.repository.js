...
export const createPerintahStokOpnameJurnalRepo = async (perintahStokOpnameJurnalData, req_id) => {
    return insertQueryUtil(
        ...
        PerintahStokOpnameJurnalModel,
        {
            ...
            kode_akun_perkiraan: perintahStokOpnameJurnalData.kode_akun_perkiraan,
            debet: perintahStokOpnameJurnalData.debet,
            kredit: perintahStokOpnameJurnalData.kredit,
            transaksi: perintahStokOpnameJurnalData.transaksi,
