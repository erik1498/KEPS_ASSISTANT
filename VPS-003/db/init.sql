...
CREATE DATABASE IF NOT EXISTS db_logging_keps_assistant_duta_multi_computer;
...
USE db_logging_keps_assistant_duta_multi_computer;
...
GRANT INSERT ON db_logging_keps_assistant_duta_multi_computer.logger_tab TO 'kepsAssistantUserDB123@#%__'@'%' IDENTIFIED BY 'kepsAssistantPassDB123@#%__';
