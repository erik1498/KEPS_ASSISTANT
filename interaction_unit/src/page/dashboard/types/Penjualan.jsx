        ...
        <div className="grid grid-cols-2 gap-x-2">
            <div className="col-span-1 justify-center my-2 flex gap-x-2 bg-white rounded-box shadow-2xl p-4">
                ...
                <div className="flex flex-col justify-around">
                    ...
                    <p className="text-sm font-bold text-gray-500">Rp. {parseToRupiahText(sumArray(dataPenjualan?.daftarTransaksi?.filter(i => i.kode_akun == "401").map(i => parseFloat(i.kredit))) - sumArray(dataPenjualan?.daftarTransaksi?.filter(i => i.kode_akun == "401").map(i => parseFloat(i.debet))))}</p>
                    <p className="text-xl font-bold text-blue-900">{dataPenjualan?.daftarTransaksi?.filter(i => i.kode_akun == "401").length} Transaksi</p>
                </div>
            </div>
            <div className="col-span-1 justify-center my-2 flex gap-x-2 bg-white rounded-box shadow-2xl p-4">
                ...
                <div className="flex flex-col justify-around">
                    ...
                    <p className="text-sm font-bold text-gray-500">Rp. {parseToRupiahText(sumArray(dataPenjualan?.daftarTransaksi?.filter(i => i.kode_akun == "405").map(i => parseFloat(i.kredit))) - sumArray(dataPenjualan?.daftarTransaksi?.filter(i => i.kode_akun == "405").map(i => parseFloat(i.debet))))}</p>
                    <p className="text-xl font-bold text-blue-900">{dataPenjualan?.daftarTransaksi?.filter(i => i.kode_akun == "405").length} Transaksi</p>
                </div>
            </div>
        </div>
    </div>
